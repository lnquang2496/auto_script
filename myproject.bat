...
call set PCL_NAME=IMR_INT_V3H_B_V1_unit_test_specification_imr_Kernel.xlsx
call set TP_DIR=UTP_IMR_driver_kernel
...
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_init_devtree --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_init_channel --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_iodev_init --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_iodev_init_core --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_iodev_read_reg --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_iodev_write_reg --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_iodev_write_status --source %SRC_NAME% --check_seq Trmyue --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_interrupt_handler --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_read_reg --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_drvknl_write_reg --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
...
REM call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
REM call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_osal_ctl_init --source %SRC_NAME% --check_seq False --can_dir %CANTATA_DIR%
REM call python myproject.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_osal_ctl_deinit --source %SRC_NAME% --check_seq False --can_dir %CANTATA_DIR%
