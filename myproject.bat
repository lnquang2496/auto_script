@echo off
call cls
call set PCL_PATH=D:\repo\s920\trunk\_project\06_Test_Specification\02_UnitTest\INT_V3H_PA_19027_B

REM /* IMR State ******************************************************************************/

call set PCL_NAME=IMR_INT_V3H_B_V1_unit_test_specification_imr_state.xlsx
call set TP_DIR=ut_imr_state
...
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_imr_set --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_imr_get --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_imr_lock --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_imr_unlock --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%

call set SRC_NAME=r_imr_rtt_state_mng
call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
call python create_memdump.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet no_use --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_rtt_set --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_rtt_get --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_rtt_lock --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_rtt_unlock --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_state_rtt_get_channel --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%

REM /* IMR Kernel *****************************************************************************/

REM call set PCL_NAME=IMR_INT_V3H_B_V1_unit_test_specification_imr_driver.xlsx
REM call set TP_DIR=ut_imr
...
REM call set SRC_NAME=r_imr_dlapi_ins
REM call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
REM call python create_memdump.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet no_use --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlNop --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlTrap --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlWtl --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlWtl2 --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlWts --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlInt --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlSyncm --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlGosub --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlRet --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%

REM call set SRC_NAME=r_imr_dlapi_ins_v3h
REM call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
REM call python create_memdump.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet no_use --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlWup --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlSlp --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlStrect --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlOutnor --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlOutrot --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlSynccc --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DlSynccf --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%

REM call set SRC_NAME=r_imr_dlapi_ctl
REM call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
REM call python create_memdump.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet no_use --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_CreateDl --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_DestroyDl --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_ClearDl --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet R_IMR_RewindDl --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%

REM call set SRC_NAME=r_imr_dlapi_cmn
REM call python reset_stub_instance.py --can_dir %CANTATA_DIR% --source %SRC_NAME%
REM call python create_memdump.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet no_use --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_dlapi_check_dl_param --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_dlapi_add_operand --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
REM call python main.py --idir %PCL_PATH% --ifile %PCL_NAME% --wsheet r_imr_dlapi_memset --source %SRC_NAME% --check_seq True --can_dir %CANTATA_DIR%
